...
- [Spring @Transactional中的事务传播和隔离](/persistence-modules/spring-persistence-simple/spring-transactional-propagation-isolation_zh.md)
...
- [Spring Data 中的 CrudRepository、JpaRepository 和 PagingAndSortingRepository](/persistence-modules/spring-data-jpa-simple/spring-data-repositories_zh.md)
- [Spring Data JPA @查询](/persistence-modules/spring-data-jpa-simple/spring-data-jpa-query_zh.md)
- [Spring Data JPA 存储库中的派生查询方法](/persistence-modules/spring-data-jpa-simple/spring-data-derived-queries_zh.md)
- [使用 Spring Data JPA 进行分页和排序](/persistence-modules/spring-data-jpa-simple/spring-data-jpa-pagination-sorting_zh.md)
- [从Spring Data JPA资源库调用存储过程](/persistence-modules/spring-data-jpa-repo-2/spring-data-jpa-stored-procedures_zh.md)
- [Spring JPA - 多个数据库](/persistence-modules/spring-data-jpa-enterprise/spring-data-jpa-multiple-databases_zh.md)
